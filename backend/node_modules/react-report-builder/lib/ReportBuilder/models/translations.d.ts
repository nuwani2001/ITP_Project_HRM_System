...
export interface ITranslations {
    ...
    dataModelsDropdownTitle: string;
    dataModelsPlaceholder: string;
    contentTitle: string;
    ...
    filterOperationEndsWith: string;
    filterOperationNotEndsWith: string;
    filterOperationContains: string;
    filterOperationNotContains: string;
    ...
    filterOperationIsNull: string;
    filterOperationIsNotNull: string;
