...
export default function DeleteSickEmployee() {
  ...
  function deleteData(e) {
    ...
    axios.delete(`http://localhost:8070/Sickemployee/delete/${id}`).then(() => {
      alert("Treatment details deleted!");
    ...
    <div>
      <div className="container">
        ...
        <form onSubmit={deleteData}>
            <h3>Delete Medical Treatments </h3>
          <div class="form-row">
            <div class="col-md-6">
          ...
          <div class="form-row">
            <div class=" col-md-6">
              ...
              <select id="shift" class="form-control" value={shift} disabled onChange={(e) => {
          ...
          <div class="form-row">
            <div class="col-md-6">
              ...
              <input type="time" class="form-control" id="intime" value={intime} disabled onChange={(e) => {
                setintime(e.target.value);
              }} required />
            </div>
            <div class="col-md-6">
              <label for="emergency" class="form-label">Emergency Phone Number</label>
              <input type="text" class="form-control" id="emergency" value={emergency} disabled onChange={(e) => {
          ...
          <div class="form-row">
            <div class="col-md-6">
              ...
              <input type="time" class="form-control" id="outtime" value={outtime} disabled onChange={(e) => {
                setouttime(e.target.value);
              }} required />
            </div>
            <div class="col-md-6">
              <label for="sentTo" class="form-label">Sent To</label>
              <input type="text" class="form-control" id="sentTo" value={sentTo} disabled onChange={(e) => {
          ...
          <div class="form-row">
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="treatment" value={treatment} disabled onChange={(e) => {
                settreatment(e.target.value);
              }} required />
            </div>
            <div class="col-md-6">
              <label for="reason" class="form-label">Reason</label>
              <input type="text" class="form-control" id="reason" value={reason} disabled onChange={(e) => {
          ...
          <div class="mb-2">
            ...
            <input type="text" class="form-control" id="remark" value={remark} disabled onChange={(e) => {
